...
const WalletAmount = styled.div`
  ...
  min-height: auto;
  border-radius: 22px;
  background-color: var(--balance-text-color);
            ...
            <MainContainer>
                <WalletContainer>
                    ...
                    {/* <Menu>
                        ...
                        <li><a href="http://localhost:3000/" target="_blank"
                               rel="noopener noreferrer">Mint</a></li>
                    </Menu> */}
                    <Menu>
                        <li><Link to="/">Home</Link>
                        </li>
                        <li> <Link to="Mint">Mint</Link>
                        </li>
                ...
                <MintContainer>
                    ...
                    <DesContainer>
                        <Des elevation={0}>
                            <LogoAligner><GoldTitle>SolTurds</GoldTitle></LogoAligner>
                            <p>SolTurds are algo-generated, unique, disgusting, smelly, vomit inducing collectable faecal matter</p>
                        </Des>
                        <Des elevation={0}>
                            <River>
                            <img src="riverofturds.png"></img>
                            </River>
                        </Des>
