      ...
      <MainContainer className="maincontainer">
        ...
        <RightContainer className="rightcontainer">
          ...
          <InfoContainer>
            ...
            <IconContainer>
              <IconLink className="infoIcon" href="https://solturds.com" target="__blank"> <InfoIcon src="website.svg" /> </IconLink>
              <IconLink className="infoIcon" href="https://discord.gg/dKVMVV5fCR" target="__blank"> <InfoIcon src="discord.svg" /> </IconLink>
              <IconLink className="infoIcon" href="https://twitter.com/SolTurds" target="__blank"> <InfoIcon src="twitter.svg" /> </IconLink>
            </IconContainer>
          </InfoContainer>
